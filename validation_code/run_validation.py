...
import pandas as pd
from models.subtypePredictor import test_all_models
import pickle
...
def main(args):
    ...
    refit_models = pickle.load(open(interim_path / 'output_refits_{}.pkl'.format(dataset), 'rb'))
    test_all_models(X, y, refit_models,  save_dir=interim_path, omicsComb=dataset, random_state=str(seed))
